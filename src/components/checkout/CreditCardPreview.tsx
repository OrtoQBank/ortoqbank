...
const detectCardType = (
  ...
  if (
    /^(4011|4312|4389|4514|4576|5041|5066|5090|6277|6362|6363|6504|6505|6516)/.test(
      cleanNumber,
    )
  ) {
    return 'Elo';
...
export function CreditCardPreview({
  ...
  const [cardType, setCardType] =
    useState<ReturnType<typeof detectCardType>>('Generic');
    ...
    <div className="flex justify-center py-6">
      <CreditCard className="w-full max-w-sm">
        <CreditCardFront className="bg-gradient-to-br from-slate-800 via-slate-700 to-slate-900">
          ...
          <div className="absolute bottom-[5%] left-0 flex w-[calc(100%-60px)] items-end justify-between px-2">
          ...
          {cardType !== 'Generic' && (
            <CreditCardServiceProvider
              type={cardType}
              className="absolute right-2 bottom-2 max-h-[30px] max-w-[50px]"
            />
          )}
        </CreditCardFront>
      </CreditCard>
